...
## 项目简介
BioKG 是一个动态生物医学知识图谱系统，旨在整合和利用来自 KEGG 数据库和 PubMed 文献的生物医学信息。该系统通过构建和维护一个 Neo4j 知识图谱，并结合检索增强生成（RAG）技术，提供智能问答和知识探索功能。它特别关注酶、基因、疾病和化合物之间的关系，并通过增量更新管道保持知识图谱的及时性。
